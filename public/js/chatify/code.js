...
$(document).ready(function () {
  ...
  $("body").on("click", ".messenger-list-item", function () {
    ...
    $(".messageList").removeClass('d-flex');
    $(".messageList").addClass('d-none');
    $(".messageBody").removeClass('d-none');
    $(".viewUserInfo").removeClass('d-none');
    $(".noView").removeClass('d-flex');
    $(".noView").addClass('d-none');
  });
  ...
  $(".show-listView").on("click", function () {
    ...
    $(".listHead").addClass('d-flex');
    $(".messenger-listView").show();
    $(".viewUserInfo").addClass('d-none');
    $(".noView").addClass('d-flex');
    $(".noView").removeClass('d-none');
  });
