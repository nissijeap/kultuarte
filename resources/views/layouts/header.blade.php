...
<!-- navigation top-->
<div class="nav-header bg-transparent shadow-xs border-0">
    <a href="default-settings.html" class="p-0 ms-3 menu-icon"><img src="{{ asset('assets/images/profile-4.png') }}" alt="user" class="w40 mt--1"></a>
    ...
    <a href="default.html" class="p-2 text-center ms-3 menu-icon center-menu-icon" style="margin-left:50px !important; font-size:20px; color:white; text-decoration:none;">Hello, {{ auth()->user()->name }}!</a>
    ...
    <form action="#" class="float-left header-search p-2 text-center ms-auto" style="margin-right:15px;">
