            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>New Post</h3>
                        <p class="text-subtitle text-muted">Add new post.</p>
                    </div>
            ...
            <div class="col-md-12 col-12">
                <div class="card">  
                    <div class="card-content">
                        <div class="card-body">
                        <form class="form form-horizontal" method="POST" action="{{ route('posts.store') }}"  enctype="multipart/form-data">
                            @csrf
                                <div class="form-body">
                                    <div class="row">
                                    ...
                                    <div class="col-md-10 form-group">
                                        ...
                                        <div class="col-md-10 form-group">
                                            <textarea type="text" id="content" class="form-control" aria-describedby="Text help" name="content"  placeholder="What's on your mind?" required></textarea>
                                        </div>
