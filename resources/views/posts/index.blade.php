        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('posts.index') }}">Arts</a></li>
          ...
          <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="col-1">
                        @can('create-post')
                        <a href="{{ route('posts.create') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i></a>
                        @endcan
                    </div>
                </div>
              <div class="row">
                          ...
                          <tr>
                              ...
                              <td>
                                <form id="delete-form-{{ $post->id }}" action="{{ route('posts.destroy', $post->id) }}" method="post">
                                    ...
                                    <a href="{{ route('posts.show', $post->id) }}" class="btn btn-outline-primary"><i class="fa fa-eye"></i></a>

                                            <button type="button" class="btn btn-outline-danger delete-btn" title="Delete" data-id="{{ $post->id }}">
