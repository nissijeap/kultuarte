...
<div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html"><img src="<?php echo url('mazer')?>/dist/assets/compiled/svg/logo.svg" alt="Logo" srcset=""></a>
            </div>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                class="sidebar-item  {{ Request::is('posts') ? 'active' : '' }} ">
            ...
            <!-- <li
                class="sidebar-item  has-sub {{ Request::is('components/*') ? 'active' : '' }}">
