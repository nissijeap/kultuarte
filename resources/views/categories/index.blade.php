                    ...
                    <tbody>
                      @forelse($categories as $index => $category)
                          <tr>
                              ...
                              <td>
                                  <a href="{{ route('categories.edit', $category->id) }}" class="btn btn-outline-warning" title="Edit">
                              ...
                              <form id="delete-form-{{ $category->id }}" action="{{ route('categories.destroy', $category->id) }}" method="POST" style="display: inline-block;">
                                  @csrf
                                  @method('DELETE')
                                  <button type="button" class="btn btn-outline-danger delete-btn" title="Delete" data-id="{{ $category->id }}">
