                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Enter details to create a new category.</p>
                                    <form action="{{ route('categories.store') }}" method="POST" class="forms-sample">
                                        @csrf
                                        <div id="permissionInputs">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" class="form-control permissionInput" name="categories[0][name]" placeholder="Name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                <button type="button" class="btn btn-success addPermissionInput"><i class="fa fa-plus-circle"></i> More Category</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
        ...
        $(".addPermissionInput").click(function () {
            var inputGroup = `
                <div class="form-group">
                    <div class="row">
                        <div class="col-11">
                            <input type="text" class="form-control permissionInput" name="categories[${permissionIndex}][name]" placeholder="Name" required>
                        </div>
                        <div class="col-1">
