                        ...
                        <div class="col-md-9">
                            ...
                            <div class="d-lg-flex post-entry-2">
                                <a href="" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                                    <img src="{{url('guest/assets/img/posts/art/installation/installation-1.jpg')}}" class="img-fluid">
                                </a>
                                <div>
                                    <div class="post-meta"><span class="date">IVA Reunion</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                    ...
                                    <div class="d-flex align-items-center author">
                                        <div class="photo"><img src="{{url('guest/assets/img/posts/art/installation/authors/author-1.jpg')}}" class="img-fluid"></div>
                                            <div class="name">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="post-entry-1 border-bottom">
                                            <a href=""><img src="{{url('guest/assets/img/posts/art/installation/installation-2.jpg')}}" class="img-fluid"></a>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="post-entry-1">
                                            <a href=""><img src="{{url('guest/assets/img/posts/art/installation/installation-3.jpg')}}" class="img-fluid"></a>
                                            <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
