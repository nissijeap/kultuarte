            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        ...
                        <p class="text-subtitle text-muted">Update existing role.</p>
                    </div>
                            ...
                            <div class="col-md-12 col-12">
                                ...
                                <form action="{{ route('roles.update', $role->id) }}" method="post">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="overflow-auto" style="max-height: 210px;">
                                                @forelse ($permissions as $permission)
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="permission_{{ $permission->id }}" value="{{ $permission->id }}" name="permissions[]" {{ in_array($permission->id, $rolePermissions ?? []) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="permission_{{ $permission->id }}">
                                                            {{ $permission->name }}
                                                        </label>
                                                    </div>
                                                @empty
                                                    <!-- Add a default message if there are no permissions -->
